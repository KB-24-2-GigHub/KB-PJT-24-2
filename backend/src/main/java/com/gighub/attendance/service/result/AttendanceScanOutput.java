 ...
 */
public record AttendanceScanOutput(AttendanceScanResult response, boolean replayed) {

    public static AttendanceScanOutput first(AttendanceScanResult response) {
        return new AttendanceScanOutput(response, false);
    }

    public static AttendanceScanOutput replayed(AttendanceScanResult response) {
