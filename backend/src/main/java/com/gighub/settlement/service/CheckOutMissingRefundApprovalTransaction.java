...
/** OWNER 퇴근 누락 환불과 해당 Operation Claim 완료를 하나의 Transaction으로 묶습니다. */
@Service
@RequiredArgsConstructor
public class CheckOutMissingRefundApprovalTransaction {
    ...
    private RuntimeException translateOwnerRejection(SettlementPayoutDecision decision) {
        return switch (decision) {
            ...
            case INTEGRITY_VIOLATION ->
                    new EscrowIntegrityException("퇴근 누락 환불 Snapshot의 무결성이 올바르지 않습니다.");
